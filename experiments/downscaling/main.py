...
from correction.models.loss import StationMSE
import os
...
from correction.train_downscaling import train
from correction.train_and_test import train_and_test
from correction.models.build_module import build_downscaling_model, build_scheduler
...
criterion = StationMSE(logger=logger).to(cfg.GLOBAL.DEVICE)

metadata = train_dataset.metadata
model = build_downscaling_model(cfg.run_config.model_type, metadata)
...
if cfg.run_config.run_mode == "train+test":
    ...
    train_and_test(train_dataloader, valid_dataloader, test_dataloader, model, optimizer, wrf_scaler, criterion,
